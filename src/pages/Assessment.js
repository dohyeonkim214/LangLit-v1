...
const Assessment = () => {
    ...
    const currentQuestion = questions[currentQuestionIndex];
    return (_jsxs("div", { className: "h-screen p-4 bg-gradient-to-b from-green-50 to-green-100 flex flex-col justify-center items-center", children: [_jsx("h1", { className: "text-2xl font-bold mb-4", children: "Assessment" }), _jsx("div", { className: "w-full max-w-lg bg-gray-300 h-2 rounded mb-6", children: _jsx("div", { className: "bg-green-500 h-2 rounded", style: { width: `${progress}%` } }) }), _jsx("div", { className: "p-4 bg-white rounded shadow-lg max-w-md mb-4", children: _jsxs("p", { className: "text-sm italic text-gray-600 mb-2", children: ["\"", currentQuestion.passage, "\""] }) }), _jsx("p", { className: "text-lg mb-4", children: currentQuestion.questionText }), _jsx("div", { className: "space-y-2 mb-4", children: currentQuestion.options.map((option, index) => (_jsx("button", { onClick: () => setSelectedAnswer(option), className: `w-full p-2 rounded-lg border ${selectedAnswer === option ? "bg-blue-500 text-white" : "bg-white text-gray-700"}`, children: option }, index))) }), _jsx("button", { onClick: handleAnswerSubmit, disabled: !selectedAnswer, className: "px-4 py-2 bg-green-500 text-white rounded disabled:bg-gray-400", children: "Submit Answer" })] }));
};
